...
class UserWatchedPage extends Component {
  ...
  loadItem = async () => {
    ...
    axios
      .get("http://wordballoon.net:5050/api/searchword/mywatch/" + this.userid)
      .then((response) => {
  ...
  render() {
    ...
    return (
      <div className="scroll">
        <Header />
        <Navi />
        <div className="UserWatchedPage">
          <p>{this.searchword} 내가 최근 본 영상 :</p>
