        ...
        <div class="navi">
          <ul id="group_all">
            <li class="group">
              ...
              <ul class="sub">
                <li>
                  <a href="http://wordballoon.net:3000/UserWatched">
                    최근 본 영상
                  </a>
                </li>
                <li>
                  <a href="http://wordballoon.net:3000/UserLike">
                    좋아요 한 영상
                  </a>
                </li>
              </ul>
            ...
            <li class="group">
              ...
              <ul class="sub">
                <li>
                  <a href="http://wordballoon.net:3000/CategoryKor">
                    한국 영상
                  </a>
                </li>
                <li>
                  <a href="http://wordballoon.net:3000/CategoryEng">
                    영어 영상
                  </a>
                </li>
                <li>
